...
register(
    ...
    kwargs={'dataset_folder' : os.path.abspath('../../graph_collision_checking_dataset/dataset_herb_1'),
            'mode' : 'train'}
)
...
register(
    id='graphEnvHerb-v2',
    entry_point='sp_rl.envs:GraphEnvHerb',
    kwargs={'dataset_folder' : os.path.abspath('../../graph_collision_checking_dataset/dataset_herb_2'),
            'mode' : 'train'}
)
...
register(
    id='graphEnvHerb-v3',
    entry_point='sp_rl.envs:GraphEnvHerb',
    kwargs={'dataset_folder' : os.path.abspath('../../graph_collision_checking_dataset/dataset_herb_3'),
            'mode' : 'train'}
)
...
register(
    id='graphEnvHerb-v4',
    entry_point='sp_rl.envs:GraphEnvHerb',
    kwargs={'dataset_folder' : os.path.abspath('../../graph_collision_checking_dataset/dataset_herb_4'),
            'mode' : 'train'}
)
