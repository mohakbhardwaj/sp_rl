...
folders=(${base_folder}'dataset_2d_1/dagger_linear_quad' ${base_folder}'dataset_2d_2/dagger_linear_quad' ${base_folder}'dataset_2d_3/dagger_linear_quad'\
         ${base_folder}'dataset_2d_4/dagger_linear_quad' ${base_folder}'dataset_2d_5/dagger_linear_quad' ${base_folder}'dataset_2d_6/dagger_linear_quad'\
         ${base_folder}'dataset_2d_7/dagger_linear_quad' ${base_folder}'dataset_2d_8/dagger_linear_quad')
