#!/usr/bin/env bash
base_path='../../sp_rl_new_experiments/dataset_2d_8/lsp_selectors_valid/'
...
dagger_file8='../../sp_rl_new_experiments/dataset_2d_8/dagger_linear_strollr/test_results.json'
dagger_file9='../../sp_rl_new_experiments/dataset_herb_5/dagger_linear_strollr/test_results.json'
echo ${dagger_file}
python analyze_results.py --files ${dagger_file5} #${dagger_file2} ${dagger_file3} ${dagger_file4} ${dagger_file5} ${dagger_file6} ${dagger_file7}
