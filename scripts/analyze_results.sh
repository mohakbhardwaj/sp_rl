...
dagger_file1='../../sp_rl_new_experiments/dataset_2d_1/dagger_linear_strollr/test_results.json'
...
dagger_file8='../../sp_rl_new_experiments/dataset_herb_4/dagger_linear_mix/test_results.json'
echo ${dagger_file}
python analyze_results.py --files ${dagger_file1} #${dagger_file2} ${dagger_file3} ${dagger_file4} ${dagger_file5} ${dagger_file6} ${dagger_file7}
