...
base_folder='../../rss_sp_rl/experiments/2d_datasets/'
folders=(${base_folder}'dataset_2d_1/dagger_linear_hroh' ${base_folder}'dataset_2d_2/dagger_linear_hroh' ${base_folder}'dataset_2d_3/dagger_linear_hroh'\
         ${base_folder}'dataset_2d_4/dagger_linear_hroh' ${base_folder}'dataset_2d_5/dagger_linear_hroh' ${base_folder}'dataset_2d_6/dagger_linear_hroh'\
         ${base_folder}'dataset_2d_7/dagger_linear_hroh' ${base_folder}'dataset_2d_8/dagger_linear_hroh')

# folders=(${base_folder}'dataset_2d_5/dagger_linear' ${base_folder}'dataset_2d_6/dagger_linear')
run_idxs=(0 1 2 3 5 6 7 8)
