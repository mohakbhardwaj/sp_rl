...
valid_envs=('graphEnv2DTest-v1' 'graphEnv2DTest-v2' 'graphEnv2DTest-v3' 'graphEnv2D-v4' 'graphEnv2DTest-v5' \
            'graphEnv2D-v6' 'graphEnv2D-v7' 'graphEnv2D-v8' 'graphEnvHerbTest-v4' 'graphEnvHerbTest-v5')


base_folder='../../../../../Documents/rss_2019_spotlight_data/'
...
for ((i=0;i<${#run_idxs[@]};++i)); do
  ...
  python2.7 example_dagger.py --env ${train_envs[idx]} --valid_env ${valid_envs[idx]} --folder ${folders[idx]} --num_iters ${num_iters}\
         ...
         --weight_decay ${weight_decay} --seed_val ${seed_val} --model_file ${model_files[idx]} --test --quad_ftrs  --render --dump #--step
done
